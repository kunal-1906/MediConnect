...
const bookAppointmentController = async (req, res) => {
    try {
      ...
      const formattedTime = moment(req.body.time, 'HH:mm').toDate();
  
      // Create a new appointment with the correct data
      const newAppointment = new appointmentModel({
        userId: req.body.userInfo._id,  // Assuming req.body.userInfo._id exists
        doctorId: req.body.doctorInfo._id,  // Assuming req.body.doctorInfo._id exists
        date: formattedDate,
        time: formattedTime,
        status: 'pending',
      });
      ...
      // Fetch the doctor to send them a notification
      const doctor = await userModel.findOne({ _id: req.body.doctorInfo.userId });
  
      // Add a notification to the doctor's account
      if (doctor) {
